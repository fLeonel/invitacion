...
const validGuests = [
  { name: "Gladys Ambrocio", guests: 4 },
  { name: "Marlon Santos", guests: 3 },
  { name: "Isaac Tojes", guests: 2 },
  { name: "Magaly Ambrocio", guests: 3 },
  { name: "Roberto Maida", guests: 3 },
  { name: "Sergio Armas", guests: 3 },
  { name: "Enrique Ambrocio", guests: 6 },
  { name: "Carlos Ambrocio", guests: 4 },
  { name: "Gilberto Aldana", guests: 2 },
  { name: "Luis Alberto Aldana", guests: 4 },
  { name: "Boanerges Ronquillo", guests: 5 },
  { name: "Juana Catalán", guests: 1 },
  { name: "Fernanda Catalán", guests: 3 },
  { name: "Lucrecia Rosales", guests: 4 },
  { name: "Manuel Castañeda", guests: 5 },
  { name: "Oracio Rosales", guests: 2 },
  { name: "Darío Pérez", guests: 4 },
  { name: "David Rosales", guests: 5 },
  { name: "Kevin Casiano", guests: 4 },
  { name: "Adelaido Ambrocio", guests: 1 },
  { name: "Nery Ronquillo", guests: 1 },
  { name: "Angela Ramón", guests: 5 },
  { name: "Oscar Sil", guests: 1 },
  { name: "Julio Flores", guests: 1 },
  { name: "Josue Jiménez", guests: 1 },
  { name: "Kelvin Hernández", guests: 1 },
  { name: "Kevin Pérez", guests: 1 },
  { name: "Lisa Borrayo", guests: 1 },
  { name: "Elvis López", guests: 3 },
  { name: "Erick Aguilar", guests: 2 },
  { name: "Jeimy Pelén", guests: 3 },
  { name: "Sofia Rivera", guests: 1 },
  { name: "Katherine Orellana", guests: 2 },
  { name: "Laura Gatica", guests: 2 },
  { name: "Gary Quintanilla", guests: 2 },
  { name: "Girsa Cristel", guests: 3 },
  { name: "Emanuel Perla", guests: 1 },
  ...
  { name: "Jorge Culpatán", guests: 1 },
  { name: "Norma López", guests: 3 },
  { name: "Karina Barrios", guests: 2 },
  { name: "Kederlyn Ochoa", guests: 2 },
  { name: "Elva López", guests: 4 },
  { name: "Augusto Santiso", guests: 1 },
  { name: "Mireira Juárez", guests: 4 },
  { name: "Elida Ambrocio", guests: 2 },
  { name: "Lucy Ambrocio", guests: 2 },
  { name: "Mario Ambrocio", guests: 2 },
  { name: "Gustavo Ambrocio", guests: 2 },
  { name: "Adelsa Ambrocio", guests: 2 },
  { name: "Marlon Ramírez", guests: 1 },
  { name: "Estefany Monterroso", guests: 3 },
  { name: "Arcenio Mancilla", guests: 2 },
  { name: "Bartolo Ronquillo", guests: 2 },
  { name: "Valerio Ronquillo", guests: 2 },
];
